...
private:	
	...
	double _Bivariate_Gaussian(double mu_x, double mu_y, double sigma_x, double sigma_y, double x, double y);
...
public:
	 ...
	 */
	void updateWeights(double sensor_range, double std_landmark[], const vector<LandmarkObs> &observations,
